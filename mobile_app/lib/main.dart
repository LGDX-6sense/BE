...
class _MainShellState extends State<MainShell> {
  ...
  Widget _buildBottomNav() {
    ...
    final items = <({IconData? icon, String? assetPath, String label})>[
      (icon: null, assetPath: 'assets/icon/bar_home.png', label: '홈'),
      (icon: null, assetPath: 'assets/icon/bar_dev.png', label: '디바이스'),
      (icon: null, assetPath: 'assets/icon/bar_chat.png', label: '챗봇'),
      (icon: null, assetPath: 'assets/icon/bar_care.png', label: '케어'),
      (icon: null, assetPath: 'assets/icon/bar_menu.png', label: '메뉴'),
    ];
...
class _MobileHomePageState extends State<MobileHomePage> {
  ...
  static const List<String> _serviceActionKeywords = [
    ...
    '서비스신청', '서비스 신청', '수리신청', '수리 신청', '수리 접수', 'as접수', 'as 접수',
    // 상담사 연결
    '상담', '상담사', '상담원', '고객센터', '콜센터', '전화', '통화',
    '사람이랑', '직원', '연결',
    // 방문/출장 예약
    '출장', '방문', '기사', '기사님', '접수',
    '예약', '예약하기', '예약 해줘', '예약해줘', '예약 부탁', '예약 부탁해',
    '수리 예약', '방문 예약', '출장 예약', '출장 서비스',
    '서비스 예약', '상담 예약', '서비스센터', '서비스 센터',
  ];
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Image.asset(
                            ...
                            filterQuality: FilterQuality.medium,
                            color: _isSubmitting
                                ? const Color(0xFF606C80).withValues(alpha: 0.4)
                                : const Color(0xFF606C80),
                        ...
                        const SizedBox(width: 7),
                        GestureDetector(
                          onTap: (_isSubmitting || showMicAction)
                              ? null
                              : _sendMessage,
                          child: _isSubmitting
                              ? const SizedBox.square(
